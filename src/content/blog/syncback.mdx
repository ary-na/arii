---
title: 'syncback'
description: 'a tiny node cli that merges your current branch into one or more targets, pushes, and switches you back automatically — with dry-run mode, auto-stash, conflict safety, and a clean summary'
pubDate: 'May 18 2026'

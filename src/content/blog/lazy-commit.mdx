---
title: 'lazy-commit'
description: 'a tiny node cli that turns your staged git diff into a conventional commit message using openai, anthropic, or groq with a config wizard, dry-run mode, regenerate, inline editing, and a confirmation prompt before committing'
pubDate: 'May 14 2026'
